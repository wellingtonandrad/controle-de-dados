...
const formSchema = z.object({
    ...
    organizationId: z.string().min(1, "Empresa é obrigatória"),
})
    ...
    try{
        ...
        try {
            ...
            const checkout = await stripe.checkout.sessions.create({
                ...
                success_url: `${baseUrl}/empresa/${encodeURIComponent(schema.data.organizationId)}?payment=success&session_id={CHECKOUT_SESSION_ID}`,
                cancel_url: `${baseUrl}/empresa/${encodeURIComponent(schema.data.organizationId)}?payment=cancelled`,
                metadata: {
