            ...
            >
              ...
              <CardContent className="p-0  " >
                  ...
                  <div className="relative h-48" >
                    ...
                    {clinic?.subscription?.status === "active" && clinic?.subscription?.plan === "PROFESSIONAL" && <PremiumCarBadge/>}
                  ...
                  <div className="p-4 space-y-4 min-h-[160px] flex flex-col justify-between" >
                      ...
                      target="_blank"
                      className="w-full bg-emerald-500 hover:bg-emerald-400 text-white flex items-center justify-center py-2 
