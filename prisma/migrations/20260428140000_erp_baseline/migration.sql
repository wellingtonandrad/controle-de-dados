...
-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('EXTERNAL', 'ACCOUNT_HOLDER');

-- CreateEnum
CREATE TYPE "OrganizationMemberRole" AS ENUM ('OWNER', 'MANAGER', 'STAFF');
...
-- CreateIndex
CREATE INDEX "StockItem_organizationId_active_idx" ON "StockItem"("organizationId", "active");
